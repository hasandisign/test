...
net = jetson.inference.imageNet(argv=["--model="+basedir+"/Documents/new_classifi/jetson-inference/python/training/classification/models/ttrain_models/jpn1_cam0_resnet50.onnx", "--labels="+basedir+"/Documents/new_classifi/jetson-inference/python/training/classification/data/ttrain_data/labels.txt", "--input-blob=input_0", "--output-blob=output_0",""+basedir+"/src/trt_pose/tasks/human_pose/train_scenario2.mp4"])

net1 = jetson.inference.imageNet(argv=["--model="+basedir+"/Documents/new_classifi/jetson-inference/python/training/classification/models/ttrain_models/jpn1_cam1_resnet50.onnx", "--labels="+basedir+"/Documents/new_classifi/jetson-inference/python/training/classification/data/ttrain_data/labels.txt", "--input-blob=input_0", "--output-blob=output_0",""+basedir+"/src/trt_pose/tasks/human_pose/train_scenario2.mp4"])
...
# Release everything if job is finished
    ...
    #imgg = input.Capture()
    class_id2, confidence2 = net1.Classify(cuda_mem2)
    print("camera2:")
    print(class_id2)
    #####train class
