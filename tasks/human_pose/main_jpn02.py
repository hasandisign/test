...
def upload_video_to_s3(data1,data2,video_name,video_name2,ACCESS_KEY_ID,ACCESS_SECRET_KEY,BUCKET_NAME):
   ...
   #s3.Bucket(BUCKET_NAME).put_object(Key='jetson101/camera1/'+args.file1+'.mp4', Body=data2)
...
## addh hgere the access key and sectret key for s3 bucket along with bucket name
...
myMQTTClient = AWSIoTMQTTClient("bipunclient")
...
while True:
    ...
    if now_upload.second<=capture_time and out!= None:
        out.write(dst1)
